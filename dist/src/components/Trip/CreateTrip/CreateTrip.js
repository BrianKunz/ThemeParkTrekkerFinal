...
function CreateTrip() {
    ...
    return (react_1.default.createElement("form", { onSubmit: handleSubmit, method: "POST" },
        ...
        react_1.default.createElement(react_datepicker_1.default, { selected: formInputs.start_date, onChange: (date) => {
                if (date !== null) {
        ...
        react_1.default.createElement(react_datepicker_1.default, { selected: formInputs.end_date, onChange: (date) => {
                if (date !== null) {
