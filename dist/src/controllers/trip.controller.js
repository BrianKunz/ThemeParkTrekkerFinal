...
// Index
tripController.get("/", (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
// Show
tripController.get("/:id", (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const { rows } = yield database_1.default.query("SELECT * FROM trips WHERE id = $1", [id]);
        const trip = rows[0];
        if (!trip) {
...
// Create
tripController.post("/", (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
// Update
tripController.put("/:id", (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { title, date, start_date, end_date, flight } = req.body;
    const { id } = req.params;
    try {
        const { rows } = yield database_1.default.query("SELECT * FROM trips WHERE id = $1", [id]);
...
tripController.delete("/:id", (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const { rows } = yield database_1.default.query("SELECT * FROM trips WHERE id = $1", [id]);
        const trip = rows[0];
